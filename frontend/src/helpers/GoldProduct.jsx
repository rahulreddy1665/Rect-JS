...
import { openModal, closeAllModals, useModals } from "@mantine/modals";
import { DatePicker } from "@mantine/dates";
import { Link, useNavigate } from "react-router-dom"; // For import the react dom for navigation components
import { customLoader, dataSlice, nFormatter, selectFilter } from "./common";
import {
  Box,
  PremiumRights,
  Receipt,
...
import { dataSearch, Th } from "./tableFunction";
import { CSVLink } from "react-csv";
import excel from "../assets/images/excel.png"; // Image for excel export
import pdf from "../assets/images/pdf.png";

function GoldProduct({ value, title, list, customerModal, setCustomerModal }) {
