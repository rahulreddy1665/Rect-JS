...
import { customLoader, dataSlice, onDownload } from "../../helpers/common"; // Common fuctions uses for applications
...
function WeekReport(props) {
  ...
  const [dateRange2, setDateRange2] = useState("1");
  ...
  const AddInvoice = async (e) => {
    var firstDay = new Date(Number(dateRange), Number(dateRange2) - 1, 1); //get first day of the year
    var lastDay = new Date(Number(dateRange), Number(dateRange2) - 1 + 1, 0);
  ...
  const print = () => {
    ...
    var body = [
      ...variables.data.map((el) => [
        ...
        el.gst_amount / 2,
        el.total_amount,
        el.tax_invoice_transactions.length,
      ]),
    ];
    doc.autoTable({
  ...
  return (
    <div>
      ...
      <Skeleton radius="md" visible={variables.skeletonLoading}>
        <BreadCrumb Text="GST Invoice Report" />
      </Skeleton>
                ...
                <Group spacing="xs">
                  ...
                  <CSVLink
                    ...
                    headers={[
                      ...
                      { label: "Hospital Gst", key: "client_gst" },

                      //   { label: " Patient Name", key: "patient_name" },
                      //   { label: "IP Num", key: "ip_num" },
                      // { label: "DL Num", key: "dl_num" },
                      // { label: "DC Num", key: "dc_num" },
