...
import { Plus, Trash, X } from "tabler-icons-react";
...
function SaveEdit() {
  ...
  const AddSaleData = async () => {
    ...
    const response = await handleAddCreateInvoice(reg);
    if (response.status === 200) {
      navigate("/invoice_print/" + response.data.data[0].dataValues.value);
                    ...
                    {formBarcode.values.product_type == "Implant" ? (
                      <Select
                        ...
                        onChange={(e) => {
                          ...
                          formBarcode.setFieldValue("price", Number(pp.price));
                      ...
                      <TextInput
                        ...
                        size="xs"
                        variant="filled"
                        value={formBarcode.values.product}
                        label="Product Name"
                        placeholder="Product Name"
                        {...formBarcode.getInputProps("product")}
                      />
                    )}
                  </Grid.Col>
                  <Grid.Col span={6}>
